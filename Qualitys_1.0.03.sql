...
INSERT INTO `rangos_qs` VALUES (1,1,100,3,1,1);
...
INSERT INTO `usuarios` VALUES (1,'admin','admin',1,1,'2013-07-17 09:59:50'),(2,'carga','carga',2,1,'0000-00-00 00:00:00');
...
(1,'Imágenes torcidas','Estas imágenes tienen un pequeño torcimiento que hace que aparezcan bordes negros en 3 o 4 
lados de la imagen.\nDistinguir de la digitalización de fotocopias que ya cuentan con ese problema.','torcida.png',1),
(2,'Imágenes con bordes Negros','Estas imágenes tienen bordes negros ya sea a ambos lados de la imagen o bien por 
arriba y por debajo.\nDistinguir de la digitalización de fotocopias que ya cuentan con ese problema.','bordesNegros.png',1),
(3,'Imágenes en blanco','Estas imágenes no contienen ningún tipo de información y por lo tanto deben ser eliminadas
.\nSi hay un sello, una firma, un número, etc. no se considerarán como error.','blancas.png',1),
(4,'Imágenes con mal contraste','Estas imágenes son ilegibles, ya sea por mucho contraste (oscuras), o 
poco contraste (muy claras).','malContraste.png',1),
(5,'Imágenes mal rotadas','Estas imágenes están con la orientación 
equivocada, sea que están de costados o vueltas hacia arriba.','malRotada.png',1),
(6,'Imágenes de alimentación múltiple','Estas imágenes reflejan que paso más de un papel 
al mismo tiempo por el scanner, superponiendose y por la tanto perdiendo información.','alimMultiple.png',1),
(7,'Imágenes con esquinas dobladas','Estas imágenes reflejan que la hoja se encontraba doblada sobre si misma, 
...
-- Dump completed on 2013-08-06 14:08:51
