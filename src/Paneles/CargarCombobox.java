 ...
 * @author MUTNPROD003
 */
public class CargarCombobox extends JComboBox<Object> {
    private JComboBox tipoDocumento;
    private JComboBox tipoVerificacion;
    private Conexion conexion ;

    public CargarCombobox(JComboBox tipoDocumento, JComboBox tipoVerificacion, Conexion conexion) {
        ...
        if (conexion.isConexion()) {
                try {
                    ...
                    Logger.getLogger(CargarCombobox.class.getName()).log(Level.SEVERE, null, ex);
                }
