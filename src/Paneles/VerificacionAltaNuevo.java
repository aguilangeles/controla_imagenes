 ...
 * @author MUTNPROD003
 */
public class VerificacionAltaNuevo {

    private String nombre;
    private String descripcion;
    private List<Object> tablaDestinoSelect;
    private Conexion conexion;
    private TiposVerificacion tVf;
    private DefaultTableModel modelo;
    private JTable tabla;

    VerificacionAltaNuevo(String text, String text0, List<Object> idTipoControl, Conexion conexion, DefaultTableModel modelo, JTable tabla) {
        this.nombre = text;
        this.descripcion = text0;
        this.tablaDestinoSelect = idTipoControl;
    ...
    public void insertarTipos_Control() {
        ...
        tVf = new TiposVerificacion(id, getNombre(), getDescripcion(), 1, null);
        for (Object o : tablaDestinoSelect) {
    ...
    public void insertarModelo() {
        ...
        for (Object object : tablaDestinoSelect) {
        ...
        tVf.setListaControles(tiposControlVerificacionList);
        String ret = tVf.getListaControles().toString();
        String trat = ret.substring(1, ret.length() - 1).replace(", ", "\n");
        modelo.addRow(new Object[]{tVf.getId(), tVf.getNombre(), tVf.getDescripcion(), trat, tVf.getEstado()});
