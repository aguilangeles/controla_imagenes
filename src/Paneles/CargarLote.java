...
public class CargarLote extends javax.swing.JFrame {
    ...
    private writeproperties.Conexion con = new writeproperties.Conexion();
    ...
    public CargarLote(TipodeUsuario usuarioTipo) {
        ...
        CargarCombobox llenarComboBox = new CargarCombobox(tipoDocumentoBox, tipoVerificacionBox, con);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleccione ruta, tipo de documento y tipo de verificacion a utilizar");
        ...
        jLabel5.setText("Tipo de Verificacion");

        tipoDocumentoBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccione el Tipo de Documento" }));

        tipoVerificacionBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccione el Tipo de Verificacion" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(24, 24, 24))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(tipoDocumentoBox)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jLabel5, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(tipoVerificacionBox, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 21, Short.MAX_VALUE)
                .addComponent(aceptarSeleccion)
                .addContainerGap())
        );
    ...
    private void aceptarSeleccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarSeleccionActionPerformed
        ...
        if (file.exists()) {
            if (tipoDocumentoBox.getSelectedItem().toString().equalsIgnoreCase("Seleccione el tipo de documento")) {
                ...
                w = new Worker(this, rutaCarpeta, getIdTipoControl(), getTipoDocumento(), getIdVerificacion(), usarioTipo.getId());
                w.execute();
            }
        } else {
