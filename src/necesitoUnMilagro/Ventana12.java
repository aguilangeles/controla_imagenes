...
public class Ventana12 extends javax.swing.JFrame {
  ...
  public Ventana12(TrazaDao traza) {
    initComponents();
...
private void internal(boolean ispdf) {
    try {
      ...
      visualizarImagen.visualizarImagen(ruta, pdf, null, null, 0.20);
      setCB.set(siguientes.getId());
    } catch (PropertyVetoException ex) {
      Logger.getLogger(Ventana12.class.getName()).log(Level.SEVERE, null, ex);
    }
  }
  ...
  private void initComponents() {
    ...
    private void siguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_siguienteActionPerformed
      ...
      try {
        ...
        visualizarImagen.visualizarImagen(ruta_temp, pdf, null, null, 0.20);
        if (!isHasNext()) {
    ...
    private void anteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anteriorActionPerformed
      ...
      visualizarImagen.visualizarImagen(pr.getRutaTemp(), pdf, null, null, 0.20);
      if (!hasPrevius) {
        anterior.setEnabled(false);
      }
