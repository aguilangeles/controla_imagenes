 ...
 * @author MUTNPROD003
 */
public class ArchivosPorTrazaListDoc {

  private String className = ArchivosPorTrazaListDoc.class.getName();
  ...
  public ArchivosPorTrazaListDoc(Conexion conexion, int idTraza, String parent) {
