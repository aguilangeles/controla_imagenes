...
//
    ...
    private final SearchImagesFromFiles searchImages;
    private TryFilechooser chooser;

    public GetFinalListOfImages(JFrame frame, JLabel infoLabel, List<Integer> controlesList, File file, int idDocumento, int idVerificacion, TryFilechooser chooser) {
