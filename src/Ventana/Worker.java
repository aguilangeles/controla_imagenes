...
public class Worker extends SwingWorker<Object, Object> {
  ...
  private void insertTrazaArchivoControles() {
    int id = getIdTraza() + 1;
  ...
  private void buscarTIF() throws HeadlessException {
  ...
  private void buscarPDF() throws HeadlessException {
  ...
  private void buscarPNG() throws HeadlessException {
